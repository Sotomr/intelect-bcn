...
FONTS: tuple[Font, ...] = (
    ...
    Font("directa", "Directa", EstatFont.rss, "Feed mitjà; RSS_FEED_SET=all o media"),
    Font("el_critic", "El Crític", EstatFont.rss, "Feed mitjà; filtre agenda estricte"),
    Font("ara_cultura", "Ara Cultura", EstatFont.rss, "RSS cultura; barreja notícies + actes"),
    Font("beteve", "Betevé", EstatFont.rss, "Feed general mitjà"),
    Font("rezero", "Rezero", EstatFont.rss, "Feed mitjà"),
